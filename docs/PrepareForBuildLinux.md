##How to prepare and build CXR-ROM in Ubuntu 14.04 or 14.10
...
```shell
$ mkdir ~/cxr-rom && cd ~/cxr-rom
$ repo init -u git://github.com/TeamCarbonXtreme/android.git -b cxr-kk
$ repo sync -j#
...
<br><br>
##CXR build script options

    Usage:
        build-cxr.sh [options] device
